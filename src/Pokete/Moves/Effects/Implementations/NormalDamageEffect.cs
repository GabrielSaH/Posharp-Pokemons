...
public class NormalDamageEffect(int accuracy, int basePower) : IMoveEffect, IDamageEffect
{
    ...
    public int CalculateBaseDamage(PosharpInstance user, PosharpInstance enemy)
    {
        ...
        int attackAndDefenseDamage = (int)Math.Round(user.CurrentAttack / enemy.CurrentDefense);
        int minimumDamage = 2;
